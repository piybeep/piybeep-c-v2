...
BusinessPage.getLayout = (
	...
	<BaseLayout reviews={reviews} services={services}>
		<Head>
			...
			<meta
				name="description"
				content="Piybeep - Веб-студия предлагает разработку веб-приложений для бизнеса и автоматизацию процессов внутри компании. Улучшите эффективность и продуктивность вашего бизнеса с нашими инновационными решениями. Профессиональный подход и высокое качество услуг."
			/>
			<meta
				name="keywords"
				content="piybeep,
