...
Home.getLayout = (
	...
	<BaseLayout reviews={reviews} services={services}>
		<Head>
			<title>
				Веб-студия разработки, дизайна и продвижения для бизнеса и маркетинга | Создание сайтов под ключ качественно и в срок | Piybeep
			</title>
			<meta
				name="description"
				content="Piybeep - Профессиональная разработка веб-сайтов под ключ с уникальным дизайном и адаптивом. Мы предлагаем такие услуги как: SEO-оптимизация, интеграция CMS систем, техническая поддержка, создание эффективных бизнес-сайтов с адаптивным интерфейсом для успешного интернет-маркетинга и продаж. Заказывайте профессиональные услуги разработки сайтов у нас и привлекайте больше клиентов"
			/>
			<meta
				name="keywords"
				content="piybeep,
