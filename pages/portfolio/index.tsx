...
Portfolio.getLayout = (
	...
	<BaseLayout services={services}>
		<Head>
			<title>Портфолио: одни из лучших проектов и работ под ключ | Piybeep</title>
			<meta name="description" content="Изучите портфолио веб-студии Piybeep с креативными проектами под ключ. Мы специализируемся на разработке уникальных сайтов, интернет-визиток, лендингов,  интернет-магазинов, порталов и других веб-решений. Посмотрите наши успешные работы и убедитесь в качестве и профессионализме нашей команды." />
