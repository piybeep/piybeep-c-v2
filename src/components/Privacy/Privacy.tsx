...
export function Privacy({ title, subtitle }: PrivacyProps) {
    return (
        <div className={s.privacy}>
            ...
            <label className={s.privacy__label} htmlFor="checkbox">{title} <a className={s.privacy__link} href="https://piybeep.com" target='_blank' rel="noreferrer">{subtitle}</a></label>
        </div>
    );
};