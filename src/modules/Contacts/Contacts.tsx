    ...
    return (
        <div className={s.wrapper}>
            ...
            <div className={s.contact}>
                <Link className={s.contact__link} href={`tel:${CONTACTS_DATA.get("phone")}`}>
                    {CONTACTS_DATA.get("phone")}
                </Link>
                <Link className={s.contact__link} href={`tel:${CONTACTS_DATA.get("phone")}`}>
                    {CONTACTS_DATA.get("phone")}
                </Link>
                <Link className={s.contact__link} href={`mailto:${CONTACTS_DATA.get("email")}`}>
                    {CONTACTS_DATA.get("email")}
                </Link>
            </div>
            <span className={s.slogan}>
                Мы всегда на связи!  Оставляйте заявку на сайте, звоните по телефону, пишите нам на почту, в телеграм, ватсап или вконтакте, и мы обсудим ваш проект!
            </span>
