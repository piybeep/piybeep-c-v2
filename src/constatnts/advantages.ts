export const ADVANTAGES_LIST = [
	...
	{
		title: "Аналитика",
		text: "На каждый сайт мы подключаем Яндекс.Метрику (и/или Google Analytics). Эти сервисы будут отслеживать действия пользователей на сайте, анализировать данные о посетителях, собирать статистику с рекламных кампаний. Очень полезный инструмент для любого владельца сайта",
		titleIcon: "lupa.svg",
	},
];
