...
export const STEPS_INFO = [
    {
        ...
        list: [
            ...
            },
            {
                ...
                text: `После утверждения ТЗ мы рисуем прототип (при необходимости), чтобы осознать, правильно ли мы поняли друг друга уже перед разработкой. Вы уже имеете готовый шаблон своего сайта и видите каким он получится в итоге.
