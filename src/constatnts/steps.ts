...
export const STEPS_INFO = [
    {
        ...
        list: [
            ...
            },
            {
                ...
                text: 'Обсуждаем и утверждаем техническое задание. Делаем смету проекта - рассчитываем предположительное количество времени, которое будет затрачено под разработку, рассчитываем стоимость. Подписываем договор'
            },
            {
                id: 2,
                title: 'Отрисовка первичной версии прототипа',
                text: `После утверждением ТЗ мы рисуем прототип (при необходимости), чтобы осознать, правильно ли мы поняли друг друга уже перед разработкой. Вы уже имеете готовый шаблон своего сайта и видите каким он получится в итоге.
                Так проще понять, что вам нужно на самом деле. В процессе можно отредактировать любой блок и любую страницу`
            },
        ]
    },
    {
